...
void main()
{
	...
	float ppSpecular		= pow( ppDiffuse, 2.0 );
	...
	vec3 landFinal			= diffuseSample * landValue + 0.5 * ppSpecularBright * landValue;
	vec3 oceanFinal			= diffuseSample * ppSpecular * oceanValue + 0.9 * oceanValue * ppSpecularBright + oceanValue * ppFresnel * 15.0;
